const layout = (() => {
    ...
    return { showPostList: showPostList, showExpertList: showExpertList, setAds: setAds, setAdInterval: setAdInterval, setLoginMemberId: setLoginMemberId, buildAvatarDataUri: buildAvatarDataUri };
})();
